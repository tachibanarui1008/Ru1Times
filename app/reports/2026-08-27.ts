...
export const realReport20260827: DailyReport = {
  id: "2026-08-27",
  date: "2026-08-27",
  published_at: "2026-08-27T20:00:00+08:00",
  updated_at: "2026-08-27T20:00:00+08:00",
  edition_number: 7,
  draft: false,
  estimated_minutes: 35,
  ai_credit: { provider: "OpenAI", model: "GPT5.6Luna", role: "资料研究、事实核查与编辑协作" },
  sources: [
    { label: "Reuters", title: "China’s Xi to attend SCO summit in Kyrgyzstan, visit Egypt", url: "https://www.internazionale.it/ultime-notizie-reuters/2026/08/26/china-s-xi-to-attend-sco-summit-in-kyrgyzstan-visit-egypt-ministry-says", published: "2026-08-26" },
    { label: "Reuters", title: "China examines new legal tool to pursue graft suspects", url: "https://malaysia.news.yahoo.com/china-examines-legal-tool-pursue-040805239.html", published: "2026-08-26" },
    { label: "Reuters", title: "Kremlin says ousted Ukrainian defence minister remarks show infighting", url: "https://www.devdiscourse.com/article/international/3968221-reuters-world-news-summary", published: "2026-08-26" },
    { label: "AP", title: "UN and Red Cross call for rules on autonomous weapons", url: "https://www.justsecurity.org/155288/early-edition-august-26-2026/", published: "2026-08-26" },
  ],
  big_story: {
    category: "Diplomacy · Law · Security",
    title_zh: "外交安排与法律工具同时推进，规则正在变得具体",
    title_en: "Diplomatic schedules and legal tools make the rules more concrete",
    summary: "8 月 26 日，多条时政线索集中出现：中方公布习近平将出席上海合作组织峰会并访问埃及；中国最高立法机关审议跨境反腐法律草案；联合国与红十字国际委员会呼吁限制自主武器。它们共同提醒读者，外交、国内法与安全规则正在相互塑形，但每条消息的法律效力和后续时间表仍需分别跟踪。",
    minutes: 8,
    source_label: "Reuters / AP",
    source_url: "https://www.internazionale.it/ultime-notizie-reuters/2026/08/26/china-s-xi-to-attend-sco-summit-in-kyrgyzstan-visit-egypt-ministry-says",
  },
  hot_words: [
